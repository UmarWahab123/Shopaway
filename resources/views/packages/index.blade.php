                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                 <a class="dropdown-item" href="{{url('admin/packagemodal/'.$row->id )}}">
                                   <i data-feather="file-text" class="mr-50"></i>
                                   <span>Detail</span>
                                    </a>
                                    <a class="dropdown-item" href="{{url('admin/packages/'.$row->id)}}">
                                        <i data-feather="edit-2" class="mr-50"></i>
                                        <span>Edit</span>
                                    </a>
                                    <a data-href="{{url('admin/deletpackage/'.$row->id)}}"  data-toggle="modal" data-target="#confirm-delete" class="dropdown-item" href="javascript:void(0);">
