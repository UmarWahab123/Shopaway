...
<style>.test{width: 36%; font-size: 15px;}</style>
@endsection
@section('breadcrumb')
...
<div class="breadcrumb-wrapper">
   <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">{{isset($data['boxes']->box_name) ? $data['boxes']->box_name : ''}} {{$data['page_title']}}</a>
      </li>
   </ol>
</div>
@endsection
         ...
         <div class="card-body">
            <div class="col-md-12">
               <div class="tab-content" id="printarea">
                  <h1 class="text-center mb-3" style="text-transform: uppercase;"><b>{{isset($data['boxes']->box_name) ? $data['boxes']->box_name : ''}} {{$data['page_title']}}</b></h1>
                  <table class="table dynamic_table font-weight-bold table-bordered">
                     <tbody>
                        <tr>
                           <td class="test"><b>Box Name</b></td>
                           <td>{{isset($data['boxes']->box_name) ? $data['boxes']->box_name : ''}}</td>
                        </tr>
                        <tr>
                           <td class="test"><b>Box Number</b></td>
                           <td>{{isset($data['boxes']->box_number) ? $data['boxes']->box_number : ''}}</td>
                        </tr>
                          <tr>
                           <td class="test"><b>Box Qr Code</b></td>
                          <td><span>{!!isset($data['boxes']->box_qr_code) ? $data['boxes']->box_qr_code : ''!!}</span>
                          </td> 
                        </tr>
                     </tbody>
                  </table>
                  <br>
               <h2 Class="text-center"><b><u>ORDERS</u></b></h2>
                    @php 
                   ...
                   @endphp
                  @foreach($data['boxes']->boxorders as $key2=>$value2)
