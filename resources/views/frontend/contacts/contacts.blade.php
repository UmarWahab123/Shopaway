               ...
               <div class="col-lg-4">
                    <div class="contact-about footer-margin">
                        <div class="about-logo">
                            <img src="{{asset(get_settings('logo'))}}" alt="Image">
                        </div>
                        <h4>We Are Glad We Can Help You</h4>
                        <p>Please call or email contact form and we will be happy to assist you.</p>
                        <div class="contact-location">
                            <ul>
                                <li><i class="flaticon-maps-and-flags" aria-hidden="true">Location</i>Islamabad Pakistan</li> 
